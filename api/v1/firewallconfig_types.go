...
type FirewallConfigSpec struct {
	...
	// foo is an example field of FirewallConfig. Edit firewallconfig_types.go to remove/update
	// +optional
...
type FirewallConfigStatus struct {
	...
	// conditions represent the current state of the FirewallConfig resource.
...
type FirewallConfig struct {
	...
	// spec defines the desired state of FirewallConfig
	// +required
	Spec FirewallConfigSpec `json:"spec"`

	// status defines the observed state of FirewallConfig
	// +optional
	Status FirewallConfigStatus `json:"status,omitzero"`
}
