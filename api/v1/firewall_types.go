...
type FirewallStatus struct {
	...
	// conditions represent the current state of the Firewall resource.
...
type Firewall struct {
	...
	// spec defines the desired state of Firewall
	// +required
	Spec FirewallSpec `json:"spec"`

	// status defines the observed state of Firewall
	// +optional
