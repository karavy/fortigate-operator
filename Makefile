...
KIND_CLUSTER ?= k8s-operator-fortigate-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name k8s-operator-fortigate-builder
	$(CONTAINER_TOOL) buildx use k8s-operator-fortigate-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm k8s-operator-fortigate-builder
	rm Dockerfile.cross
